...
class ThoughtStep:
    """
    Represents a thought step with its title, description, and optional properties.
    """
...
class Approach(ABC):
    ...
    async def compute_text_embedding(self, q: str):
        """
        Computes the text embedding for the given input.
        """
    ...
    async def compute_image_embedding(self, q: str):
        """
        Computes the image embedding for the given input.
        """
